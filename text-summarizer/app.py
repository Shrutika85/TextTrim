...
def fifty(text):
    os.environ['GOOGLE_API_KEY'] = "AIzaSyCGhiOZHTKmrdYVScmnNVAAFlmF7zsrhwU"
...
def generateSummaryJSON(data_list):
    os.environ['GOOGLE_API_KEY'] = "AIzaSyCGhiOZHTKmrdYVScmnNVAAFlmF7zsrhwU"  # Replace "YOUR_API_KEY_HERE" with your actual API key
    genai.configure(api_key=os.environ['GOOGLE_API_KEY'])
    model = genai.GenerativeModel('gemini-pro')
    summaries = []
